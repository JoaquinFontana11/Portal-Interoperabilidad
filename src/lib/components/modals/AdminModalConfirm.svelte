		...
		<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
			<div class="p-6 text-center">
				{#if status}
					<Icon
						src={CheckCircle}
						class="mx-auto w-20 h-20 text-green-500 transition duration-75 dark:text-green-400"
					/>
				{:else}
					<Icon
						src={ExclamationCircle}
						class="mx-auto w-20 h-20 text-red-500 transition duration-75 dark:text-red-400"
					/>
				{/if}
